                ...
                <div class="col-md-12">
                    <div class="full">
                        <div id="main_slider" class="carousel vert slide" data-ride="carousel" data-interval="5000">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="slider_cont">
                                                ...
                                                <Link class="main_bt_border" to="/recipes">Order Now</Link>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="slider_image full text_align_center">
                                                <img class="img-responsive" src="assets/images/burger_slide.png" alt="#" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <Link class="carousel-control-prev" to="#main_slider" role="button" data-slide="prev">
                                <i class="fa fa-angle-up"></i>
                            </Link>
                            <Link class="carousel-control-next" to="#main_slider" role="button" data-slide="next">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="assets/images/blog_img1.png" alt="#"/>
       ...
       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="assets/images/blog_img2.png" alt="#"/>
             <span>02 FEB 2019</span>
            </figure>
          </div>
          <h3>Egg & Tosh</h3>
       ...
       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="assets/images/blog_img3.png" alt="#"/>
             <span>02 FEB 2019</span>
            </figure>
          </div>
          <h3>Pizza</h3>
